...
fun ContentHomeView(navController: NavController) {
    ...
    Column(
        ...
        TitleView(name = "Apps Kotlin Neo")
        Space()


        MainButton(name = "Ir a Años perrunos App", backColor = Color.DarkGray, color = Color.White) {
            navController.navigate("DogYear")
        }
        MainButton(name = "Ir a PrecioDescuento App", backColor = Color.Red, color = Color.White) {
            navController.navigate("PrecioDescuento")
        }
        MainButton(name = "Ir a Loteria App", backColor = Color.DarkGray, color = Color.White) {
            navController.navigate("LoteriaApp")
        }
    }
}